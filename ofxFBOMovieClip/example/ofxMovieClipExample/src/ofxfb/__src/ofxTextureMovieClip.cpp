...
void ofxTextureMovieClip::gotoAndPlay(int frameNumber)
{
    ...
    playheadCount = (ofClamp(float(frameNumber-1), 0.0f,textureImageSequence->assetCollections[frameLabelId]->imageFramesSize) / textureImageSequence->assetCollections[frameLabelId]->imageFramesSize) * frameInterval;
}
...
void ofxTextureMovieClip::gotoAndStop(int frameNumber)
{
    ...
    playheadCount = (ofClamp(float(frameNumber), 0.0f, textureImageSequence->assetCollections[frameLabelId]->imageFramesSize) / textureImageSequence->assetCollections[frameLabelId]->imageFramesSize) * frameInterval;
}
